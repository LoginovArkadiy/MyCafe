...
public class UserSignUpTask extends AsyncTask<String, String, AnswerBody> {
    @Override
    protected AnswerBody doInBackground(String... params) {
        ...
        String username = params[0], password = params[2], email = params[1];
        Call<AnswerBody> call = service.loadUser(username, password, email);
        try {
